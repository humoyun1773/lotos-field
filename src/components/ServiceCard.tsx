  ...
  if (featured) {
    ...
    return (
      ...
      >
        ...
        {/* Full-width Large Background Image behind text */}
        <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden rounded-3xl">
          ...
          />
          {/* Subtle dark gradient overlay to guarantee 100% white text clarity without washing out the image */}
        ...
        <div className="relative z-10 flex-shrink-0 w-full lg:w-72 flex flex-col items-center justify-center pointer-events-none">
          <div className="relative w-full h-32 sm:h-40 lg:h-44 flex items-center justify-center drop-shadow-[0_4px_16px_rgba(0,0,0,0.6)]">
            {isEhson ? <EhsonVisual /> : <LastochkaVisual />}
          </div>
          <div className="text-center mt-1.5 sm:mt-2">
            <span className="text-[10px] sm:text-[11px] font-extrabold tracking-[0.2em] uppercase px-3.5 py-1 rounded-full border text-white bg-blue-900/85 border-white/40 shadow-md backdrop-blur-md">
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center lg:items-start text-center lg:text-left pointer-events-none w-full">
          {/* Top Tagline Pill */}
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full text-[10px] sm:text-[11px] font-extrabold tracking-wider uppercase mb-2 shadow-md border bg-blue-950/75 border-white/30 text-white backdrop-blur-md">
          ...
          <div className="flex flex-wrap gap-1.5 sm:gap-2 justify-center lg:justify-start mb-4">
            {service.features?.map((f, i) => (
              <span 
                key={i} 
                className="text-[10px] sm:text-[11px] font-bold bg-slate-950/65 backdrop-blur-md px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-xl shadow-md flex items-center gap-1 border text-white border-white/25"
              >
